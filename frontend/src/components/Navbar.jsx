    ...
    return (
        <nav className="bg-truman-purple border-gray-200 bg-gray-900 w-screen fixed top-0 left-0">
            ...
            <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button type="button" onClick={handleLogout} className="flex p-4 mr-16 text-sm bg-truman-blue border-4 border-solid border-black rounded-md focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button">
                    Logout
                </button>
